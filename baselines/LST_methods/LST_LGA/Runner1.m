% Running this m-file will start the LGA implementation part of the paper2
...
flair_path = 'C:\Users\SAI\Desktop\Desktop\raw_flair';
t1_path = 'C:\Users\SAI\Desktop\Desktop\raw_t1';
...
wmh_path = 'C:\Users\DR-Shamsi-LAB\Desktop\flair_lga';
...
%     end
    ...
    subjects_t1 = dir([subjects_fold_t1(i).folder, '/', subjects_fold_t1(i).name]);
    for k = 1:length(subjects)
        ...
        if file_name(end-5) == 'n' % file_name(end-7) == 'n' % & file_name(8:14) == 'AXFLAIR' 
            ...
            subj_name_t1 = subjects_t1(k).name;
            subj_fold_t1 = subjects_t1(k).folder;
            break
        end
    end
    flair_file = [subj_fold, '/', subj_name];
    t1_file = [subj_fold_t1, '/', subj_name_t1];

    dest_path = SPM_LST_LGA(flair_file, t1_file, wmh_path, subj_name(1:6), spm_path);
